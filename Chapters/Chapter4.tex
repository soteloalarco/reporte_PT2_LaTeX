...
\textit{Monitoreo del consumo de agua y electricidad en la ciudad} & Media a grande, cientos a miles de dispositivos & Periódico, 1 msj cada 10 min por dispositivo & Baja, tolerante al retardo 1 min & Alimentado por la red eléctrica/ autoalimentado \\ 
\textit{Control de iluminación} & Grande, miles de dispositivos & Aleatorio, poco frecuente & Media, tolerante al retardo 15 seg & Alimentado por la red eléctrica \\ 
\textit{Vigilancia de estacionamientos} & Grande, miles de dispositivos & Aleatorio, poco frecuente & Media, tolerante al retardo 10 seg & Alimentado por batería \\ 
\textit{Control del tráfico} & Grande, miles de dispositivos & Periódico, 1 msj cada 10 min por dispositivo, aleatorio para alarmas & Media, tolerante al retardo 15 seg, alta para alarmas & Alimentado por batería \\ 
\textit{Mantenimiento de deshechos} & Grande, miles de dispositivos & Aleatorio, poco frecuente & Media, tolerante al retardo 30 seg & Alimentado por batería \\ 
\textit{Monitoreo de condiciones urbanas} & Media a grande, cientos a miles de dispositivos & Periódico, 1 msj cada 15 min por dispositivo, aleatorio para alarmas & Media, tolerante al retardo 30 seg, alta para alarmas & Alimentado por batería \\ 
\textit{Monitoreo de la salud estructural de edificios} & Media a grande, cientos a miles de dispositivos & Periódico, 1 msj cada 15 min por dispositivo, aleatorio para alarmas & Media, tolerante al retardo 30 seg, alta para alarmas & Alimentado por batería \\ 
\end{tabular}
\end{table}
