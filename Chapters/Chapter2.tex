...
\subsection{Generaciones anteriores de los sistemas de comunicaciones móviles}
...
\item  Amplias bibliotecas de soporte:
\end{enumerate}

Scipy es una biblioteca de Python utilizada para la informática científica y la informática técnica. \newline

NumPy es una biblioteca de Python utilizada para la informática científica que, aparte de sus usos científicos, puede utilizarse como un contenedor multidimensional para datos genéricos.\newline
