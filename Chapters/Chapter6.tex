...
En este escenario se valida la generación de puntos siguiendo un HPPP.\newline
...
\begin{figure}[th]
    \centering
    \includegraphics[scale=.6]{Figures/PoissonDistribution}
    \decoRule
...
\myworries{TODO: ESTA GRÁFICA DEBE CORREGIRSE}\\
...
\begin{figure}[th]
    \centering
    \includegraphics[scale=.8]{Figures/PPPCirculo}
    \decoRule
    \caption[Distribución espacial de los puntos en un círculo 2D]{Distribución espacial de los puntos en un círculo 2D}
    \label{fig:generacioPPPCirculo}
\end{figure}

También se validó que todos los puntos se generen dentro del areá del circulo, para esto se graficó de igual manera la distribución espacial de los puntos en un círculo en plano 2D pero ahora con una densidad mayor, de modo que se observe que los puntos rellenan toda el área del círculo [\textit{véase Figura~\ref{fig:}}].
...
\myworries{TODO: INCLUIR GRÁFICA }\\
...
De acuerdo con el modelo de canal propuesto, el modelo CI \textit{Ecuación~\ref{eqn:CI}} \parencite{Sun2016}, este implementa pérdidas de acuerdo con la distancia dado un exponente de pérdida por trayectoria (PLE) y además, agrega pérdidas por el desvanecimiento rápido de Rayleigh.
...
\begin{figure}[th]
    \centering
    \includegraphics[scale=.6]{Figures/ExponentialDisitribution}
    \decoRule
