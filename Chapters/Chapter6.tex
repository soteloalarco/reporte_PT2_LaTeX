...
De acuerdo con el modelo de canal propuesto, el modelo CI \parencite{Sun2016} implementa pérdidas de acuerdo con la distancia dado un exponente de pérdida por trayectoria (PLE) y además, agrega pérdidas por el desvanecimiento rápido de Rayleigh.
