...
\textsc{\Large Proyecto Terminal II}\\[0.5cm] % Thesis type
...
\large \textit{Una tesis presentada en cumplimiento de los requisitos \\para el grado de \degreename}\\[0.3cm] % University requirement text
%\textit{in the}\\[0.4cm]
...
%\includegraphics{LogoUPIITA} % University/department logo - uncomment to place it
...
\myworries{TODO: Realizar la actualización del abstract y agregar su traducción}
\end{abstract}
...
\myworries{TODO: Aplicar formato IEEE para referencias}

%\bibliography{Referencias} Aqui intenté implementar Ieee pero no jaló
